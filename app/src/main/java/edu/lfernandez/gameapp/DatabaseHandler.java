...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    void addHiScore(Scores hiScore) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    Scores getHiScore(int id) {
        ...
        Scores hiScore = new Scores(Integer.parseInt(
                cursor.getString(0)),
                cursor.getString(1),
                cursor.getString(2),
                cursor.getInt(3));
    ...
    public List<Scores> getAllHiScores() {
        List<Scores> hiScoreList = new ArrayList<Scores>();
        // Select All Query
    ...
    public int updateHiScore(Scores hiScore) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteHiScore(Scores hiScore) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public List<Scores> getTopFiveScores() {
        List<Scores> hiScoreList = new ArrayList<Scores>();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_HI_SCORES +
                " ORDER BY SCORE DESC " +
